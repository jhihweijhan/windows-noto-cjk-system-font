...
Set-ItemProperty -Path $subKey -Name 'SimSun' -Value 'Noto Sans SC'
Set-ItemProperty -Path $subKey -Name 'NSimSun' -Value 'Noto Sans SC'
Set-ItemProperty -Path $subKey -Name 'PMingLiU' -Value 'Noto Sans TC'
Set-ItemProperty -Path $subKey -Name 'MingLiU' -Value 'Noto Sans TC'
