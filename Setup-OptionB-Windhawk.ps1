...
$newLink = @("NotoSansSC-Bold.ttf,Noto Sans SC Bold", "NotoSansSC-Bold.ttf,Noto Sans SC", "NotoSansSC-VF.ttf,Noto Sans SC Thin", "NotoSansSC-VF.ttf", "msyh.ttc,Microsoft YaHei UI") + $filtered
