// ==UserScript==
// @name         Noto Sans CJK 全網字型增強
// @namespace    https://github.com/jhihweijhan/windows-noto-cjk-system-font
// @version      1.0.0
// @description  強制所有網頁字型優先使用 Noto Sans TC 與 Noto Sans SC，杜絕簡體字跌入宋體
// @author       jhihweijhan
// @match        *://*/*
...
(function() {
    ...
    :where(
      ...
      header, nav, section, summary, input, button, textarea, select
        ...
        font-family: "Noto Sans TC", "Noto Sans SC", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif !important;
    }
